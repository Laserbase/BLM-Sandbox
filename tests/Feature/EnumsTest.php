...
{    
    ...
    public function listFields()
    {
        return [
            ...
            ['PROP_SUB_ID',  "68", ""],
            ['PROP_SUB_ID',  "69", "Data field 'PROP_SUB_ID', value '69' is not in the allowed list of values"],
            ['PROP_SUB_ID',  "70", "Data field 'PROP_SUB_ID', value '70' is not in the allowed list of values"],
            ['PROP_SUB_ID',  "71", ""],
            ...
            ['TENURE_TYPE_ID',            "0", "Data field 'TENURE_TYPE_ID', value '0' is not in the allowed list of values"],
            ['TENURE_TYPE_ID',            "1", ""],
            ['TENURE_TYPE_ID',            "2", ""],
            ['TENURE_TYPE_ID',            "3", ""],
            ['TENURE_TYPE_ID',            "4", ""],
            ['TENURE_TYPE_ID',            "5", ""],
            ['TENURE_TYPE_ID',            "6", "Data field 'TENURE_TYPE_ID', value '6' is not in the allowed list of values"],
            ...
            ['TENURE_TYPE_ID',            "9", "Data field 'TENURE_TYPE_ID', value '9' is not in the allowed list of values"], // 1
            ...
            ['LET_TYPE_ID',  "3", ""],
            ['LET_TYPE_ID',  "4", ""],
            ['LET_TYPE_ID',  "5", "Data field 'LET_TYPE_ID', value '5' is not in the allowed list of values"],

            ['LET_FURN_ID',  "X", "Data field 'LET_FURN_ID', value 'X' is not in the allowed list of values"],
            ...
            ['LET_FURN_ID',  "4", ""],
            ['LET_FURN_ID',  "5", "Data field 'LET_FURN_ID', value '5' is not in the allowed list of values"],

            ['LET_RENT_FREQUENCY',  "X", "Data field 'LET_RENT_FREQUENCY', value 'X' is not in the allowed list of values"],
            ...
            ['LET_RENT_FREQUENCY',  "4", "Data field 'LET_RENT_FREQUENCY', value '4' is not in the allowed list of values"],
            ['LET_RENT_FREQUENCY',  "5", ""],
            ['LET_RENT_FREQUENCY',  "6", "Data field 'LET_RENT_FREQUENCY', value '6' is not in the allowed list of values"],

            ['TRANS_TYPE_ID',  "X", "Data field 'TRANS_TYPE_ID', value 'X' is not in the allowed list of values"],
            ...
            ['TRANS_TYPE_ID',  "0", "Data field 'TRANS_TYPE_ID', value '0' is not in the allowed list of values"],
            ['TRANS_TYPE_ID',  "1", ""],
            ['TRANS_TYPE_ID',  "2", ""],
            ...
            ['PRICE_QUALIFIER',  "5", ""],
            ['PRICE_QUALIFIER',  "7", ""],
            ['PRICE_QUALIFIER',  "8", "Data field 'PRICE_QUALIFIER', value '8' is not in the allowed list of values"],
            ['PRICE_QUALIFIER',  "9", ""],
            ['PRICE_QUALIFIER',  "10", ""],
            ['PRICE_QUALIFIER',  "11", ""],
            ['PRICE_QUALIFIER',  "12", ""],
            ['PRICE_QUALIFIER',  "13", "Data field 'PRICE_QUALIFIER', value '13' is not in the allowed list of values"],
            ['PRICE_QUALIFIER',  "14", ""],
            ['PRICE_QUALIFIER',  "15", ""],
            ...
            ['PUBLISHED_FLAG',  "0", ""],
            ['PUBLISHED_FLAG',  "1", ""],
            ['PUBLISHED_FLAG',  "2", "Data field 'PUBLISHED_FLAG', value '2' is not in the allowed list of values"],

            ['LET_WASHING_MACHINE_FLAG',  "X", "Data field 'LET_WASHING_MACHINE_FLAG', value 'X' is not in the allowed list of values"],
            ...
            ['LET_WASHING_MACHINE_FLAG',  "0", "Data field 'LET_WASHING_MACHINE_FLAG', value '0' is not in the allowed list of values"],
            ['LET_WASHING_MACHINE_FLAG',  "1", "Data field 'LET_WASHING_MACHINE_FLAG', value '1' is not in the allowed list of values"],

            ['LET_DISHWASHER_FLAG',  "X", "Data field 'LET_DISHWASHER_FLAG', value 'X' is not in the allowed list of values"],
            ['LET_DISHWASHER_FLAG',   "", ""],
            ...
            ['LET_DISHWASHER_FLAG',  "0", "Data field 'LET_DISHWASHER_FLAG', value '0' is not in the allowed list of values"],
            ['LET_DISHWASHER_FLAG',  "1", "Data field 'LET_DISHWASHER_FLAG', value '1' is not in the allowed list of values"],

            ['LET_BURGLAR_ALARM_FLAG',  "X", "Data field 'LET_BURGLAR_ALARM_FLAG', value 'X' is not in the allowed list of values"],
            ...
            ['LET_BURGLAR_ALARM_FLAG',  "0", "Data field 'LET_BURGLAR_ALARM_FLAG', value '0' is not in the allowed list of values"],
            ['LET_BURGLAR_ALARM_FLAG',  "1", "Data field 'LET_BURGLAR_ALARM_FLAG', value '1' is not in the allowed list of values"],

            ['LET_BILL_INC_WATER',  "X", "Data field 'LET_BILL_INC_WATER', value 'X' is not in the allowed list of values"],
            ['LET_BILL_INC_WATER',   "", ""],
            ...
            ['LET_BILL_INC_WATER',  "0", "Data field 'LET_BILL_INC_WATER', value '0' is not in the allowed list of values"],
            ['LET_BILL_INC_WATER',  "1", "Data field 'LET_BILL_INC_WATER', value '1' is not in the allowed list of values"],

            ['LET_BILL_INC_GAS',  "X", "Data field 'LET_BILL_INC_GAS', value 'X' is not in the allowed list of values"],
            ['LET_BILL_INC_GAS',   "", ""],
            ['LET_BILL_INC_GAS', "-1", "Data field 'LET_BILL_INC_GAS' is too big, maximum length is '1', found '2'"],
            ['LET_BILL_INC_GAS',  "Y", ""],
            ['LET_BILL_INC_GAS',  "N", ""],
            ['LET_BILL_INC_GAS',  "0", "Data field 'LET_BILL_INC_GAS', value '0' is not in the allowed list of values"],
            ['LET_BILL_INC_GAS',  "1", "Data field 'LET_BILL_INC_GAS', value '1' is not in the allowed list of values"],

            ['LET_BILL_INC_ELECTRICITY',  "X", "Data field 'LET_BILL_INC_ELECTRICITY', value 'X' is not in the allowed list of values"],
            ...
            ['LET_BILL_INC_ELECTRICITY',  "0", "Data field 'LET_BILL_INC_ELECTRICITY', value '0' is not in the allowed list of values"],
            ['LET_BILL_INC_ELECTRICITY',  "1", "Data field 'LET_BILL_INC_ELECTRICITY', value '1' is not in the allowed list of values"],

            ['LET_BILL_INC_TV_LICIENCE',  "X", "Data field 'LET_BILL_INC_TV_LICIENCE', value 'X' is not in the allowed list of values"],
            ...
            ['LET_BILL_INC_TV_LICIENCE',  "0", "Data field 'LET_BILL_INC_TV_LICIENCE', value '0' is not in the allowed list of values"],
            ['LET_BILL_INC_TV_LICIENCE',  "1", "Data field 'LET_BILL_INC_TV_LICIENCE', value '1' is not in the allowed list of values"],

            ['LET_BILL_INC_TV_SUBSCRIPTION',  "X", "Data field 'LET_BILL_INC_TV_SUBSCRIPTION', value 'X' is not in the allowed list of values"],
            ...
            ['LET_BILL_INC_TV_SUBSCRIPTION',  "0", "Data field 'LET_BILL_INC_TV_SUBSCRIPTION', value '0' is not in the allowed list of values"],
            ['LET_BILL_INC_TV_SUBSCRIPTION',  "1", "Data field 'LET_BILL_INC_TV_SUBSCRIPTION', value '1' is not in the allowed list of values"],

            ['LET_BILL_INC_INTERNET',  "X", "Data field 'LET_BILL_INC_INTERNET', value 'X' is not in the allowed list of values"],
            ...
            ['AREA_SIZE_UNIT_ID',  "0", "Data field 'AREA_SIZE_UNIT_ID', value '0' is not in the allowed list of values"],
            ['AREA_SIZE_UNIT_ID',  "1", ""],
            ['AREA_SIZE_UNIT_ID',  "2", ""],
            ['AREA_SIZE_UNIT_ID',  "3", ""],
            ['AREA_SIZE_UNIT_ID',  "4", ""],
            ...
            ['BUSINESS_FOR_SALE_FLAG',  "2", "Data field 'BUSINESS_FOR_SALE_FLAG', value '2' is not in the allowed list of values"],
